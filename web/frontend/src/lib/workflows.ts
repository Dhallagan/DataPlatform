...
export const WORKFLOWS: WorkflowDefinition[] = [
  {
    ...
    actions: ['write_table:gtm.daily_lead_digest', 'send_slack:#growth', 'send_email:growth@browserbase.com'],
  ...
  },
  {
    ...
    actions: ['update_tasks:finance_close', 'write_table:fin.close_exceptions', 'send_slack:#finance'],
  ...
  },
  {
    ...
    actions: ['send_email:dunning_sequence', 'create_task:account_owner', 'write_table:fin.collections_log'],
