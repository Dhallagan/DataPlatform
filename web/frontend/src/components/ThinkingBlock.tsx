  ...
  return (
    <div className="mb-2">
      <button
        ...
        className="inline-flex items-center gap-2 rounded-full border border-border bg-surface-secondary px-3 py-1.5 text-xs text-content-tertiary hover:text-content-secondary transition-colors"
      >
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-medium">Reasoning details</span>
        </div>
